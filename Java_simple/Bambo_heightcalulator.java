...
/*
Rayan’s Bamboo Tree
Rayan bought a Bamboo tree sapling to grow in his garden and it was 3 feet tall when he planted. 
...
public class Bambo_heightcalulator {
    public static void main(String[] args) {
        ...
        if (height > 0 && height < 10000) {
            ...
            if (temp_height == height) {
                System.out.println(
                        "It will take " + year + " years for the Bamboo tree to reach a height " + height + " feet.");
            } else {
